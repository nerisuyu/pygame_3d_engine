    ...
    def draw(self, camera, renderBuffer, globalLight=None, localLights=None):
        ...
        for tri in self.__triangles:
            ...
            Triangle = Polygon(depth, 0, color,  # no
                               (self.__screenSpaceVertices[tri[0]][0] * SCREEN_WIDTH / 2 + SCREEN_WIDTH / 2,
                                self.__screenSpaceVertices[tri[0]][1] * SCREEN_HEIGHT / 2 + SCREEN_HEIGHT / 2),
                               (self.__screenSpaceVertices[tri[1]][0] * SCREEN_WIDTH / 2 + SCREEN_WIDTH / 2,
                                self.__screenSpaceVertices[tri[1]][1] * SCREEN_HEIGHT / 2 + SCREEN_HEIGHT / 2),
                               (self.__screenSpaceVertices[tri[2]][0] * SCREEN_WIDTH / 2 + SCREEN_WIDTH / 2,
                                self.__screenSpaceVertices[tri[2]][1] * SCREEN_HEIGHT / 2 + SCREEN_HEIGHT / 2))
